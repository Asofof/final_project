...
subscription_age = st.number_input("Вік підписки (місяців)", min_value=0, max_value=120, value=12)
bill_avg = st.number_input("Середній рахунок ($)", min_value=0.0, max_value=1000.0, value=50.0)
reamining_contract = st.number_input("Залишок контракту (місяців)", min_value=0, max_value=60, value=12)
